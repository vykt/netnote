...
daemon.o: daemon.c log.h config.h daemon.h request.h net_tcp.h net_udp.h vector.h error.h
	${CC} ${CFLAGS} -c log.h config.h daemon.c daemon.h request.h net_tcp.h net_udp.h vector.h error.h
