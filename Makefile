CC=gcc
CFLAGS= -Wall -ggdb
CLEAN_TARGETS=scarlet main.o request.o request.h.gch net_transfer.o net_transfer.h.gch net_tcp.o net_tcp.h.gch net_udp.o net_udp.h.gch vector.o vector.h.gch error.h.gch


scarlet: main.o request.o request.h net_transfer.o net_transfer.h net_tcp.o net_tcp.h net_udp.o net_udp.h vector.o vector.h error.h
	${CC} ${CFLAGS} -o scarlet main.o request.o request,h net_transfer.o net_transfer.h net_tcp.o net_tcp.h net_udp.o net_udp.h vector.o vector.h error.h
